...
import os
from .config import TEST, DATABASE
...
SECRET_KEY = 'rghk@-kh6h$rgkb)!e(94(f51&si7f&+tmy+xnepvx*vue)lkm'
...
STATICFILES_DIRS = (
    ...
    os.path.join(BASE_DIR, os.path.join('template', 'static')),
)
